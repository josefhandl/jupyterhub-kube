...
#echo "c.JupyterHub.spawner_class = 'dockerspawner.DockerSpawner'" >> /srv/jupyterhub/jupyterhub_config.py
...
#echo "c.KubeSpawner.namespace = 'handl2-ns'" >> /srv/jupyterhub/jupyterhub_config.py
...
#echo "c.KubeSpawner.k8s_api_host = 'https://rancher.cloud.e-infra.cz/k8s/clusters/c-m-qvndqhf6'" >> /srv/jupyterhub/jupyterhub_config.py
